...
class DynamicNumber {
    public:
        ...
        template<typename otherT>
        DynamicNumber<T> operator+(const DynamicNumber<otherT>& other) const {
            return DynamicNumber<T>(getValue() + (T(other.getValue())));
        }

        DynamicNumber<T> operator+(const DynamicNumber<T>& other) const {
             return DynamicNumber<T> newDynamicNumber(getValue() + other.getValue());
        }
...
// DynamicNumber<T> operator+(const DynamicNumber<T>& other) {
//     return DynamicNumber<T> newDynamicNumber(getValue() + other.getValue());
// }
...
int main() {
    ...
    std::cout << "----------------------------------------------------" << std::endl;
    DynamicNumber<int> dynamicNumber6_5(20);
    DynamicNumber<int> dynamicNumber7 = dynamicNumber5 + dynamicNumber6_5;
    std::cout << "dynamicNumber6_5 value: " << dynamicNumber6_5.getValue() << std::endl;
    std::cout << "dynamicNumber5 value: " << dynamicNumber5.getValue() << std::endl;
    std::cout << "dynamicNumber7 value: " << dynamicNumber7.getValue() << std::endl;
    std::cout << "----------------------------------------------------" << std::endl;
    DynamicNumber<int> dynamicNumber8 = dynamicNumber5 + dynamicNumber6;
    std::cout << "dynamicNumber6 value: " << dynamicNumber6.getValue() << std::endl;
    std::cout << "dynamicNumber5 value: " << dynamicNumber5.getValue() << std::endl;
    std::cout << "dynamicNumber8 value: " << dynamicNumber8.getValue() << std::endl;
    return 0;
}